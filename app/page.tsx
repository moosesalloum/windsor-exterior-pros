              ...
              <figure className="h-full overflow-hidden rounded-xl border border-[#E8E4DF] bg-[#F2F0ED] shadow-sm">
                <div className="relative aspect-[3/4] overflow-hidden bg-[#1A1A1A]">
                  <video
                    ...
                    playsInline
                    preload="none"
                    poster="/recent-work/covered-patio-roofline-walkthrough-poster.webp"
                    aria-label="Video walkthrough of a dark covered patio roofline"
                  >
                    <source
                      src="/recent-work/covered-patio-roofline-walkthrough.mp4"
                      type="video/mp4"
                    />
                  </video>
                </div>
                <figcaption className="border-t border-[#E8E4DF] px-5 py-4 font-heading font-semibold text-[#2C2C2C]">
                  Covered patio roofline walkthrough
                </figcaption>
              </figure>
            </AnimatedSection>
          </div>
