...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/windows-doors-installation-windsor-ontario.jpg", width: 1600, height: 900, alt: "Installer positioning a white-framed replacement window" }],
  },
  twitter: {
            ...
            <AnimatedSection delay={0.15}>
              <div className="relative rounded-xl overflow-hidden aspect-[4/3]">
                <Image
                  ...
                  alt="Installer positioning a white-framed replacement window"
                  fill
