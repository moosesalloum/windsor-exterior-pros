...
export const metadata: Metadata = {
  title: "Exterior Contractors in Windsor, Ontario",
  description:
    "Seamless eavestrough, siding, soffit & fascia, roofing, and exterior services in Windsor Ontario. Windsor Exterior Pros - free estimates, serving Windsor-Essex.",
  alternates: { canonical: "https://www.windsorexteriorpros.com/service-areas/windsor" },
  openGraph: {
  ...
  twitter: {
    ...
    title: "Exterior Contractors Windsor Ontario | Windsor Exterior Pros",
    description: "Windsor's trusted exterior contractors. Free estimates, serving Windsor-Essex.",
...
const serviceAreaSchema = {
  ...
  "@type": "Service",
  name: "Exterior Contracting in Windsor, Ontario",
  serviceType: "Exterior contracting services",
  url: "https://www.windsorexteriorpros.com/service-areas/windsor",
  provider: {
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Windsor", item: "https://www.windsorexteriorpros.com/service-areas/windsor" },
  ],
};
      ...
      <section className="py-20 bg-surface border-b border-[#E8E4DF]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-muted text-lg max-w-2xl mb-6">
            Windsor Exterior Pros serves Windsor&rsquo;s diverse
            neighbourhoods, older housing stock, and what Windsor winters do to eavestroughs,
            rooflines, and siding. Free estimates and clear project communication are available for
            exterior work throughout the city.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14">
            <AnimatedSection>
              ...
              <div className="space-y-4 text-muted leading-relaxed">
                <p>
                  We work across Windsor - from South Windsor
                ...
                <p>
                  Local service is available throughout Windsor-Essex. We provide written estimates
                  with no obligation.
                </p>
              </div>
            </AnimatedSection>
