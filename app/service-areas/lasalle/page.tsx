...
export const metadata: Metadata = {
  title: "Exterior Contractors in LaSalle, Ontario",
  description:
    "Seamless eavestrough, siding, soffit & fascia, roofing, and exterior services in LaSalle Ontario. Windsor Exterior Pros - free estimates, serving Windsor-Essex.",
  alternates: { canonical: "https://www.windsorexteriorpros.com/service-areas/lasalle" },
  openGraph: {
  ...
  twitter: {
    ...
    title: "Exterior Contractors LaSalle Ontario | Windsor Exterior Pros",
    description: "Exterior contracting services in LaSalle. Free estimates, serving Windsor-Essex.",
...
const serviceAreaSchema = {
  ...
  "@type": "Service",
  name: "Exterior Contracting in LaSalle, Ontario",
  serviceType: "Exterior contracting services",
  url: "https://www.windsorexteriorpros.com/service-areas/lasalle",
  provider: {
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "LaSalle", item: "https://www.windsorexteriorpros.com/service-areas/lasalle" },
  ],
};
            ...
            <AnimatedSection>
              ...
              <div className="space-y-4 text-muted leading-relaxed">
                ...
                <p>
                  ...
                  pricing. Local service throughout Windsor-Essex.
                </p>
              </div>
            </AnimatedSection>
