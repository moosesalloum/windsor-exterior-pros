...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://windsorexteriorpros.ca/service-areas/mcgregor" },
  openGraph: {
    title: "Exterior Contractors McGregor Ontario | Windsor Exterior Pros",
...
const localBusinessSchema = {
  ...
  url: "https://windsorexteriorpros.ca/service-areas/mcgregor",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "McGregor", item: "https://windsorexteriorpros.ca/service-areas/mcgregor" },
  ],
};
