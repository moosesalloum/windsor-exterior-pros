...
export const metadata: Metadata = {
  title: "Exterior Contractors in McGregor, Ontario",
  description:
    "Seamless eavestrough, siding, soffit & fascia, roofing, and exterior services in McGregor Ontario. Windsor Exterior Pros - free estimates, serving Windsor-Essex.",
  alternates: { canonical: "https://www.windsorexteriorpros.com/service-areas/mcgregor" },
  openGraph: {
  ...
  twitter: {
    ...
    title: "Exterior Contractors McGregor Ontario | Windsor Exterior Pros",
    description: "Exterior contracting services in McGregor. Free estimates, serving Windsor-Essex.",
...
const serviceAreaSchema = {
  ...
  "@type": "Service",
  name: "Exterior Contracting in McGregor, Ontario",
  serviceType: "Exterior contracting services",
  url: "https://www.windsorexteriorpros.com/service-areas/mcgregor",
  provider: {
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "McGregor", item: "https://www.windsorexteriorpros.com/service-areas/mcgregor" },
  ],
};
      ...
      <section className="py-20 bg-surface border-b border-[#E8E4DF]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-muted text-lg max-w-2xl mb-6">
            ...
            estimates, clear project communication on core work, and a written project scope on every job.
          </p>
            ...
            <AnimatedSection>
              ...
              <div className="space-y-4 text-muted leading-relaxed">
                ...
                <p>
                  ...
                  obligation. Local service throughout Windsor-Essex.
                </p>
              </div>
            </AnimatedSection>
