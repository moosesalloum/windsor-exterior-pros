...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://windsorexteriorpros.ca/service-areas/cottam" },
  openGraph: {
    title: "Exterior Contractors Cottam Ontario | Windsor Exterior Pros",
...
const localBusinessSchema = {
  ...
  url: "https://windsorexteriorpros.ca/service-areas/cottam",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Cottam", item: "https://windsorexteriorpros.ca/service-areas/cottam" },
  ],
};
